...
class PackingDiscrete(gym.Env):
    def __init__(self,
        ...
        self.type_gen_box = "Auto" # general nex box. Auto thì box dựa theo dataset. Manual thì phải truyền tham số vào.
        self.next_box = (0, 0, 0)
    ...
    def cur_observation(self):
        boxes = []
        leaf_nodes = []
        # if self.type_gen_box == "Manual" or self.type_gen_box == "Actual":
        #     self.next_box = self.next_box_cf
        # else:
    ...
    def step(self, action, *args):
        if self.type_gen_box == "manual":
            self.next_box_cf = args
